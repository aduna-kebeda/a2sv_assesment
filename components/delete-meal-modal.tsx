  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-2xl w-full max-w-md p-6 shadow-2xl">
        <h2 className="text-2xl font-bold text-primary-500 mb-4">Delete Meal</h2>
        ...
        <div className="flex gap-3">
          <Button
            ...
            disabled={loading}
            className="flex-1 bg-red-500 hover:bg-red-600 text-white h-12 font-semibold shadow-lg hover:shadow-xl transition-all disabled:opacity-50"
          >
            {loading ? (
              <>
          ...
          <Button
            ...
            onClick={onClose}
            disabled={loading}
            className="flex-1 h-12 font-semibold border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 dark:text-gray-200"
          >
            Cancel
          </Button>
        </div>
